...
const About = () => {
    return (
        <div className="lg:max-w-[1180px] h-full container  font-Inter mx-auto mb-20  md:grid grid-cols-2 gap-10">
            <div className="">
                ...
                <button className="btn bg-yellow-300 px-3 py-1 mt-8"> Learn More <MdArrowOutward /> </button>
            </div>

            <div className="relative">
                <img src="Rectangle 24.png" alt="" className="lg:absolute" />
                <div className="lg:absolute lg:-left-24 lg:-bottom-12  lg:w-[395px] h-[210px] bg-primary py-5 px-9 rounded-[32px] text-white">
