        ...
        <div className="bg-gradient-to-b mb-36 from-[#bbbbc7] to-[#FFFFF5] " >
            <div className="pt-10 lg:max-w-[1180px] h-full mx-auto  lg:grid grid-cols-5 gap-5">
                <div className="hidden lg:flex">
                    <div className="col-span-1 bg-[#FBFBFB] border border-[#e1e1e4]  rounded-3xl p-[20px]">
                ...
                <div className="col-span-3">
                    ...
                    <div className=" grid grid-cols-3 items-end justify-center gap-5">
                        <div className="col-span-1 border border-[#e1e1e4] bg-[#FBFBFB]  rounded-3xl p-[20px]">
